    ...
    <View style={[$viewContainer, { width }]}>
      ...
      <View style={$viewTextSection}>
        <View style={{ flexDirection: commonStyles.rowList.flexDirection }}>
          ...
          <Text
            testID="title_2"
            tx={"onBoarding.on4_title.title_2"}
            size="xxl"
            weight="bold"
            style={{
        ...
        <Text
          testID="title_3"
          tx={"onBoarding.on4_title.title_3"}
          size="xxl"
          weight="bold"
          style={{
            color: colors.palette.textDark,
      ...
      <View style={$bodySection}>
        <Text
          testID="title_1"
          tx={"onBoarding.on4_title.bodyText_1"}
          size="md"
          weight="medium"
          style={{
            color: colors.palette.textDark,
