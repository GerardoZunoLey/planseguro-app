...
export const iconRegistry = {
  ...
  pin_icon: require("../../assets/icons/pin.png"),
  home: require("../../assets/icons/home.png"),
  lihome: require("../../assets/icons/LiHouse.png"),
  notification: require("../../assets/icons/notification.png"),
  map_line: require("../../assets/icons/map_line.png"),
  map: require("../../assets/icons/map.png"),
  search_line: require("../../assets/icons/search_line.png"),
  search: require("../../assets/icons/search.png"),
  location: require("../../assets/icons/location.png"),
  pinMap: require("../../assets/icons/pin_map.png"),
  owner: require("../../assets/icons/owner.png"),
  address: require("../../assets/icons/address.png"),
  onBoarding1: require("../../assets/icons/on1.svg"),
}
